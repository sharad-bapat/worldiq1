...
function showItem(index) {
    try {
        ...
        <div class="container p-2">
            ...
            <div class="col-12"><img src="${item.visual}" loading="lazy" class="img-fluid rounded" alt="..." style="width:90vw;height:200px; object-fit:cover" onerror="removeImage(this)"></div> 
