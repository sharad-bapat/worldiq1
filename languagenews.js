...
function showItem(index) {
    try {
        ...
        <div class="container">
            ...
            <div class="col-12"><img src="${item.socialimage}" class="img-fluid rounded" alt="..." style="width:90vw;height:35vh; object-fit:contain" onerror="removeImage(this)"></div> 
...
function getCountryNews(lang) {
    if (lang) {      
        const url = `https://api.gdeltproject.org/api/v2/doc/doc?query=sourcelang:${lang}&mode=artlist&format=json&maxrecords=75&sort=datedesc`;
        fetch(url)
